...
def process_file(file_name):
    ...
    try:
        ...
        command = (
            'bash -c "source ~/.bashrc && cat targets.txt | httpx -stream -rl 500 | xargs -I{} -P150 bash -c \'echo {} | timeout 40 katana -u - -em js,php -d 10 -c 500 | sort -u | nuclei -t ./app/yam.yaml -duc -stream -nh -rl 800\' | tee final_results.txt || true"'
        )
